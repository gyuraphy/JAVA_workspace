...
public class CompanyTest {
	...
	public static void main(String[] args) {
		Company company1; // 인스턴스 멤버 변수를 선언만 한것.		
		Company company2;
		...
		System.out.println("comopany1의 주소값: " + company1);
		System.out.println("comopany2의 주소값: " + company2);
		System.out.println("comopany3의 주소값: " + company3);
